...
lastModified: '2024-09-14T07:00:26.723Z'
title: How to create a fullstack application using Django and Python Part 14
author: Maria D. Campbell
excerpt:
    How to create a fullstack application using Django and Python Part 14. In
    this section, I talk about how to save user input to the database, and build
    a NewTopicForm,
