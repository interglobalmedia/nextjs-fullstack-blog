...
excerpt:
    Using a POST request in a local environment using VS Code's REST Client
    extension.
...
**_Photo by_** [Sandra Harris](https://unsplash.com/@girasolmom) **_on_**
[unsplash.com](https://unsplash.com/photos/cT0PH_bkLlQ)
...
**_Screenshot of REST Client VS Code extension local environment POST request_**
