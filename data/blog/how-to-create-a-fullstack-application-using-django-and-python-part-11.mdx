...
lastModified: '2024-09-11T14:30:51.443Z'
title: How to create a fullstack application using Django and Python Part 11
author: Maria D. Campbell
excerpt:
    'How to create a fullstack application using Django and Python Part 11. In
    this section, I update the class models in boards/models.py to include
...
The`self.assertEqual()` function is a Python `unit test` library `function` used
in `unit testing` to `check` the `equality` of `two values`. `In` our `case`, to
