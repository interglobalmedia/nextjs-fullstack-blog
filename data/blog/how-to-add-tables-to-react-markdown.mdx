...
lastModified: '2026-05-24T04:34:01.578Z'
title: How to add tables to React Markdown
author: 'Maria D. Campbell'
excerpt: How to create tables in React Markdown.
...
`npm uninstall remark-gfm` (`gfm` stands for Github Flavored Markdown) and then
re-installed it with `npm i remark-gfm@3.0.1 -S`. Then I did the following
inside my `post-content.js` file which is the component that renders the
markdown content of my posts on this site:
...
if you are a `next.js` and `tailwind.css` user, I also added a bit of styling
for dark mode in my (global) `post-content.scss` file:
