...
excerpt:
    The bug I encountered when typing non-alpha numeric characters in a text
    editor on my Mac, and how I came to fix the issue.
...
**_Photo by_** [Luke Chesser](https://unsplash.com/@lukechesser) **_on_**
[unsplash.com](https://unsplash.com/photos/1uxV8fAfhVM)
...
- [Dictation is not working on Mac OS X & macOS, how do I fix it?](https://appletoolbox.com/2012/08/mac-os-x-dictation-not-working-how-to-fix/):
  **_by Elizabeth Jones, AppleToolBox_**
