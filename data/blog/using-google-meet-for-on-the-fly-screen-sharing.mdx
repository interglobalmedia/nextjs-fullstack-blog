...
excerpt:
    How one can use the Google Meet video conferencing app with screen sharing
    capability.
...
**_Photo by_** [Joshua Sortino](https://unsplash.com/@sortino) **_on_**
[unsplash.com](https://unsplash.com/photos/71vAb1FXB6g)
