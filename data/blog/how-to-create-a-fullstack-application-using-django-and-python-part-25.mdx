...
lastModified: '2026-07-11T19:39:47.216Z'
title: How to create a fullstack application using Django and Python Part 25
author: Maria D. Campbell
excerpt:
    'In this section, I added the Humanize package to my templates/topics.html,
added the Gravatar package for user gravatars, and added the django-avatar
...
In this section, I _added_ the `Humanize` package to my `templates/topics.html`,
added the `Gravatar` package for user gravatars, and added the `django-avatar`
package for automatic implementation of a user avatar when one is absent.
