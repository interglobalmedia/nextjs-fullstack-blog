...
lastModified: '2026-05-24T07:19:33.119Z'
...
Specifically, `django-admin` is Django's command-line utility for administrative
tasks. It performs administrative tasks related to Django, such as starting a
Django project or creating a new Django app.
...
Ignore the warning about unapplied database migrations for now. It will be dealt
with shortly.
...
[^2]:
    ...
    Django 4 and later. Python 3 has native syntax for handling asynchronous
