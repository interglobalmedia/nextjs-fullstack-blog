...
lastModified: '2026-05-24T04:22:11.344Z'
...
_Photo by_ [Hans Reniers](https://unsplash.com/@hansreniers) _on_
[Unsplash](https://unsplash.com/photos/mE6e5-5jLu8)
...
`easier` if you don’t commit a file before deciding to ignore it. If you do
commit a file and then decide to ignore it later, you will have to execute some
extra commands before doing so. I will discuss how to ignore a file you have
already committed in another post.
