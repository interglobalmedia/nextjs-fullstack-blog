...
-   [Running the (default) script command in Linux and Unix (macOS)](#running-the-default-script-command-in-linux-and-unix-macos)
-   [Running custom scripts in Unix (macOS)](#running-custom-scripts-in-unix-macos)
