...
lastModified: '2024-09-27T15:47:45.109Z'
...
1. Then I `create` a `soup` object (`required`) and `set` it to
   ...
   _followed by_ `sv.select()` where I `select` the ~~`ids`~~ `.signup-form`
   class of the signup form so that I can view the entire form when I run my
   tests. The other thing I include is the line
