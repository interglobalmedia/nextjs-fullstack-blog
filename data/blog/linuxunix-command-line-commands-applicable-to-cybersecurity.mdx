...
lastModified: '2026-05-29T13:42:33.365Z'
...
_Photo by_ [Pew Nguyen](https://www.pexels.com/@nguyendesigner/) _\_on_
...
version is `IPv6`, and `TCP *:http-alt` refers to a
[wildcard DNS record](https://www.cloudns.net/wiki/article/190/). It is used to
match requests for non-existent domain names. Like in the case here.
