...
[unsplash.com](https://unsplash.com/photos/fVzrhGkLLaY)
...
**Next**, I _**added**_ the `production` **url** I **used** as the `value` of
the `production host` in `settings.json` **inside** `rest-client.txt`:
...
**_Send Request Link with Send Request text_**
...
**_Send Request Link with GET Request_**
...
**_Response to Request in New Browser Window_**
