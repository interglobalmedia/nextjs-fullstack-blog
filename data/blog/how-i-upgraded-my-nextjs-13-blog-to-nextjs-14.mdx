...
***Photo b***y [Heliberto Arias](https://unsplash.com/@helibertoarias) **_on_**
...
[Making the Git pre-commit hook work on macOS](blog/making-the-git-pre-commit-hook-work-on-macos),
