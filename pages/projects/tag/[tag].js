...
import { getProjectsByTag, getAllProjectTags } from '../../../lib/projects-util'
...
export const PROJECTS_PER_TAG_PAGE = 10

export default function ProjectTag({ projects, tag, currentPage, totalPages }) {
	return (
		<Fragment>
			<Head>
				<title>projects tag: {tag}</title>
			</Head>
...
export async function getStaticProps({ params: { tag } }) {
	...
	const projects = allTagProjects.slice(0, PROJECTS_PER_TAG_PAGE)
	return {
