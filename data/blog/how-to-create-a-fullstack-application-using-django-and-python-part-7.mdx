...
lastModified: '2024-09-03T01:01:28.248Z'
...
([reverse relationship](/blog/how-to-create-a-fullstack-application-using-django-and-python-part-6#uml-class-diagram-which-visualizes-fields-and-not-relationships))
`from` _the related_ `Board object` back to `Topic`. `After` defining
`related_name`, we can `retrieve` the `topics` of a `board` with the
`following`:
...
([reverse relationship](/blog/how-to-create-a-fullstack-application-using-django-and-python-part-6#uml-class-diagram-which-visualizes-fields-and-not-relationships))
`from` _the related_ `Topic object` back to `Post`. `After` defining
...
attribute that we `use` for the `relation`
([reverse relationship](/blog/how-to-create-a-fullstack-application-using-django-and-python-part-6#uml-class-diagram-which-visualizes-fields-and-not-relationships))
...
`reverse relationship` from `being created`. We `prevent` it from
