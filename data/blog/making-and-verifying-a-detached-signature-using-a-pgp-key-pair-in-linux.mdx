...
lastModified: '2026-05-29T16:51:14.043Z'
...
When we create a "complete" signature as we did with the `gpg` extension by
...
unreadable in transit (complete signature)?" or "Is it more important that the
