...
lastModified: '2026-07-11T15:29:47.084Z'
...
reply_topic.html and topic_posts.html templates, and I implemented ES6 modules
...
modules to my JavaScript code. This meant refactoring the copy (link) button and
associated HTML markup and CSS. I refactored and modularized the scroll top and
bottom button JavaScript code and associated CSS, modularized the pagination
behavior JavaScript code, imported the ES6 modules into a new file called
`app.js`, and added the `type="module"` attribute to the `app.js` script tag in
`templates/base.html`.
