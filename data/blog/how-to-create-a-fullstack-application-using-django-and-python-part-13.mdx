...
lastModified: '2024-09-12T02:14:56.432Z'
title: How to create a fullstack application using Django and Python Part 13
author: 'Maria D. Campbell'
excerpt:
    'How to create a fullstack application using Django and Python Part 13. In
    this section, I created a reusable, base template called base.html,
...
i`ntegrated` it into `index.html`, `integrated` it into `topics.html`, `tested`
django_boards `after` making those `changes`, `added` a `navigation menu` to
