...
**Note 5.21.19:** Some information here might be a bit outdated, but deploying
to `gh-pages` with git subtree is not. So I decided to bring this gem back to
the blog here.
...
workflows. I have worked hard at creating seamless processes for regular ES6+
