...
lastModified: '2026-07-11T15:08:56.432Z'
...
`base.html`, created an `app.css` file in the `static/css` directory, changed
the logo font with a Google font which I imported into `app.css`, and tweaked
the logo styling with CSS.
