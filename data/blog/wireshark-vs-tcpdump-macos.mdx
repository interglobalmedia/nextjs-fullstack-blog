...
lastModified: "2023-12-11T18:36:24.375Z"
title: "Wireshark vs tcpdump (macOS)"
author: "Maria D. Campbell"
excerpt: "First, in order to be able to compare Wireshark tot tcpdump, I had to install them."
image: pexels-george-desipris-726478.jpg
tags: ["command line", "command line utility", "cybersecurity", "macOS", "network protocol analyzer", "network traffic analyzer", "network traffic capture", "tcpdump", "wireshark"]
isPublished: true
isFeatured: true
---
...
- Wireshark is a graphic user interface, whereas tcpdump is a command line interface (CLI) tool. Wireshark's graphical user interface provides a user friendly experience, and it has advanced features such as real-time analysis and fitering. tcpdump is ideal to run in remote servers or devices for which a GUI is not available, to collect data that can be analyzed later.

- tcpdump is lightweight and can be used on servers without a graphical user interface. This makes it a great choice for network administrators who [need to monitor remote servers](https://skillsstreet.com/mainframe-vs-server/). On the other hand, Wireshark is typically deployed on workstations instead of servers, because it comes with a GUI that offers more advanced features and greater flexibility.
...
- BatsouElefecause Wireshark is a GUI with more complex features, it consumes more system resources.
