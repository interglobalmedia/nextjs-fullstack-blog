...
lastModified: '2026-05-25T03:42:52.689Z'
...
posts (1 like per post), and a post like can have a relationship with many
users. In other words, many users can like many posts.

So what then, is the `ManyToManyDescriptor`? It is is an object that manages the
