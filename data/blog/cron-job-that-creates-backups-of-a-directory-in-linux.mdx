...
lastModified: '2024-08-08T02:59:40.355Z'
...
execute permissions, which is necessary for shell script files. So next, I have
to run the following in Terminal to add execute permissions to
