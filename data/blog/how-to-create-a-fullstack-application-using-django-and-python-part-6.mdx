...
lastModified: '2024-09-01T14:36:58.280Z'
title:
    How to create a fullstack application using Django and Python Part 6. In
    this section, I go over aspects of designing Django Boards. I discuss the
...
excerpt: How to create a fullstack application using Django and Python Part 6.
...
-   [Designing the Django Boards application](#designing-the-django-boards-application)
    ...
    -   [Class Diagram visualizes how the classes (models) relate to each other](#class-diagram-that-visualizes-how-the-classes-models-relate-to-each-other)
...
[Django Forum](https://www.djangoproject.com).
...
### Class Diagram visualizes how the classes (models) relate to each other
