...
lastModified: '2026-05-29T00:26:31.796Z'
title: Jest, React and Mocks
author: Maria D. Campbell
excerpt: How to set up Jest and mocks in React.
...
_Jest, React, and Mocks_

I use Facebook's Jest to test my React applications. Yesterday, I ran a test to
make sure that the changes I made to my `Work` component passed in my Portfolio
React app. It did not! But as indicated in the iTerm2 console, It was not
because of any errors in the `Work` component. It was because I am using a
`.pdf` file in my `About` component, and Jest does not take kindly to it.
...
Then why was this happening? I mock out files for Jest to ignore in my
...
So if you are using Jest to run tests in your React application, make sure that
you mock out certain types of assets that would otherwise cause your tests to
fail! I have included links to resources related to this topic at the end of the
article.
