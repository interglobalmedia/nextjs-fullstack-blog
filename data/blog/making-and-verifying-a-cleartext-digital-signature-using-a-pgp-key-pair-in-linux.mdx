...
gpg:                using RSA key 3032629044B2173D7D8A1F48C96D8B4D4E580179
...
-   [Making and verifying a clear text signature using a PGP key pair in Linux](/blog/making-and-verifying-a-clear-text-signature-using-a-pgp-key-pair-in-linux)
