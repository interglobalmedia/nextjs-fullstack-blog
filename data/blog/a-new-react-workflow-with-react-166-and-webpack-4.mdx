...
excerpt: I updated my React workflow with React 16.6 and Webpack 4+.
image: react-workflows.webp
tags:
    [
        'css modules',
...
![Screenshot of a slide from the React Workflows presentation slide deck](react-workflows.webp)

_Screenshot of a slide from the React Workflows presentation slide deck_

To view the second edition of my custom React workflow, please visit the
...
changes in React 16.6 and Webpack 4.3.0. A lot has changed since last year when
I put my last workflow together and documented it.
...
> ["Free software is suffering because coders don’t know how to write documentation"](https://t.co/yIAMZolG30)
> _via_ [@thenextweb](https://twitter.com/TheNextWeb?ref_src=twsrc%5Etfw) —
> _docToolchain (@docToolchain)_
> [November 7, 2018](https://twitter.com/docToolchain/status/1060105284105003009?ref_src=twsrc%5Etfw)
...
When I had first added `CSS modules` functionality, I had done so to an app
created with
[Create React App](https://github.com/facebook/create-react-app/blob/master/packages/react-scripts/template/README.md).
This time, I add it to my own React workflow I use in a `React` application NOT
created with
[Create React App](https://github.com/facebook/create-react-app/blob/master/packages/react-scripts/template/README.md).
