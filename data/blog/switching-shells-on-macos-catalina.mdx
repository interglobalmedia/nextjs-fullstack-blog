...
excerpt:
    Why one should switch over to the ZShell from Bash if one has macOS Catalina
...
**_Photo by_**
[Christina Victoria Craft](https://unsplash.com/@victoriabcphotographer)
**_on_** [unsplash.com](https://unsplash.com/photos/qyPAFcZnwZw)
...
**_Switching Shells from Bash to Zsh_**
