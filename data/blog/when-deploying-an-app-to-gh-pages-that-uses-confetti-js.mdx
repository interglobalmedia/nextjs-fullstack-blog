...
excerpt:
    How to add the confetti-js npm package to an application you are hosting on
    Github gh-pages.
...
**_Photo by_** [Hugo Ruiz](https://unsplash.com/@2hrrc) **_on_**
[unsplash.com](https://unsplash.com/photos/e2pVrE1PYzs)
