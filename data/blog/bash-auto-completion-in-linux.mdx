...
zsh auto-completion feature and wanted to implement it in Linux bash as well.'
...
_Photo by_ [Robert So Robert So](https://www.pexels.com/@robertkso/) _on_
...
I found that I just had to install an Ubuntu package called `bash-completion`.
Linux Mint is a derivative of Ubuntu, so no problem there!
...
up again to make sure that it recognized the package installation. Then I tested
