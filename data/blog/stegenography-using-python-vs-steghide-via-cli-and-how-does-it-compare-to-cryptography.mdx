...
title: "Stegenography using Python vs Steghide via CLI (and how does it compare to Cryptography?)"
author: "Maria D. Campbell"
excerpt: "Steganography is a method in which secret messages are hidden in cover media."
image: pexels-andrea-piacquadio-3768723.jpg
tags: ["command-line", "cryptography", "cybersecurity", "macOS", "python", "steganography", "steghide"]
isPublished: true
isFeatured: true
---
...
*Created By [Andrea Piacquadio](https://www.pexels.com/@olly/) on [pexels.com](https://www.pexels.com/)*
...
*Output text screenshot in jpg format*
...
*Output text screenhot in png format*
...
The main difference between Cryptography and Steganography is that Cryptography protects the contents of data or messages, and Steganography hides the contents. Even though both can be used for good, Steganography is easier and commonly used by cyber threat actors.
...
**This post was originally published on Github under the repository named** [image-steganography-steghide](https://github.com/interglobalmedia/image-steganography-steghide).
## Related Resources
